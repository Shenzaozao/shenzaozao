...
public interface OrderMapper extends BaseMapper<Orders> {
    ...
    int selectPrize(int pId);

    int selectDoctorPrize(int dId);

    int selectBalance(int pId);

    void updateBalance(@Param("pId")int pId,@Param("pBalance") int pBalance);

    void updatePrize(int pId);
}
