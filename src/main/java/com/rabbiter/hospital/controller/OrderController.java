...
public class OrderController {
    ...
    public ResponseData updatePrice(int oId, int pId ,int oTotalPrice, int dId){
        if (this.orderService.updatePrice(oId))
        return ResponseData.success("根据id设置缴费状态成功",this.orderService.updateBalance(dId, pId,oTotalPrice));
