...
public class PatientController {
    ...
    public ResponseData login(@RequestParam(value = "pId") int pId, @RequestParam(value = "pPassword") String pPassword) {
        ...
        if (patient != null) {
            ...
            map.put("pIsvip", patient.getPIsvip().toString());
    ...
    public ResponseData topUp(@RequestParam(value = "pId") int pId, @RequestParam(value = "balance") int balance){
        return ResponseData.success("返回挂号信息成功", this.patientService.topUp(pId, balance)) ;
    }
}
