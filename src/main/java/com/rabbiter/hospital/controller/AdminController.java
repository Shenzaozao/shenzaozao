...
public class AdminController {
    ...
    public ResponseData findPatients(@RequestParam(value = "pageNumber") int pageNumber, @RequestParam(value = "size") int size, @RequestParam(value = "query") String query){
        return ResponseData.success("返回普通患者信息成功",  this.patientService.findPatients(pageNumber, size, query));
    }
     ...
     * @return
     */
    @RequestMapping("findVPatients")
    public ResponseData findVPatients(@RequestParam(value = "pageNumber") int pageNumber, @RequestParam(value = "size") int size, @RequestParam(value = "query") String query){
        return ResponseData.success("返回会员患者信息成功",  this.patientService.findVPatients(pageNumber, size, query));
    }
    /**
     * 删除患者信息
     */
